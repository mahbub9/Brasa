...
- ✅ **Built, tested, and proven live** (not just unit-tested — see §3a):
  ...
  **real RLS** (DAT-01…06),
  ...
  orders — ORD-14, new `OrderStatus.Merged`, no migration needed/even or
  by-item split — ORD-15/16/pre-bill preview — ORD-18/19, provably
  non-fiscal, see §7/close/history-search — ORD-22), `Floor` (rooms, tables, full `Free ⇄ Occupied ⇄ Dirty ⇄ Free`
  ...
  UI (`src/web/e2e`, QA-01/03/05/14 incl. axe-core accessibility scans, 29
...
ORD-01/02/03/04/**05**/**06**/**12**/**13**/**14**/15/**16**/**18**/**19**/**22** ·
