...
- ✅ **Built, tested, and proven live** (not just unit-tested — see §3a):
  ...
  **real RLS** (DAT-01…06),
  ...
  UI (`src/web/e2e`, QA-01/03/05/14 incl. axe-core accessibility scans, 122
...
editor (WEB-10's menu slice) are done and proven; price lists (CAT-05) and
staff/reporting screens (WEB-11) are not. The floor-plan editor (FLR-03) is
🚧 — table CRUD is done, the drag-and-drop canvas its own title names is not.
