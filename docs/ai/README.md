...
- ✅ **Built, tested, and proven live** (not just unit-tested — see §3a):
  ...
  **real RLS** (DAT-01…06),
  ...
  evenly, by item or by cover — ORD-15/16/17/pre-bill preview — ORD-18/19,
  ...
  UI (`src/web/e2e`, QA-01/03/05/14 incl. axe-core accessibility scans, 31
...
ORD-01/02/03/04/**05**/**06**/**12**/**13**/**14**/15/**16**/**17**/**18**/**19**/**22** ·
