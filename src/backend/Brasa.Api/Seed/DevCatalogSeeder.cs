...
public static class DevCatalogSeeder
{
    ...
    public static async Task SeedAsync(IServiceProvider services, IHostEnvironment environment, CancellationToken cancellationToken)
    {
        ...
        db.Items.AddRange(
            ...
            new MenuItem(principais.Id, "Frango na Brasa", Money.FromDecimal(9.50m), VatRate.IntermediateMainland),
            ...
            new MenuItem(bebidas.Id, "Água", Money.FromDecimal(1.50m), VatRate.IntermediateMainland),
